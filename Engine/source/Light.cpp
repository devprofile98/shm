...
namespace SHM {
        ...
        direction(direction), position(position)
    {
        ...
        Engine::getRenderer()->GetUtility()->uploadVec4(
                    ...
                    memory_offset + 2*sizeof(glm::vec4),
                    sizeof(glm::vec4)
                    );
        ...
        Engine::getRenderer()->GetUtility()->uploadVec4(
                    ...
                    memory_offset + 3*sizeof(glm::vec4),
                    sizeof(glm::vec4)
                    );
        ...
        Engine::getRenderer()->GetUtility()->uploadVec4(
                    ...
                    memory_offset + 4*sizeof(glm::vec4),
                    sizeof(glm::vec4)
                    );
        ...
        Engine::getRenderer()->GetUtility()->uploadFloat(
                    Engine::getRenderer()->ubo_spots,
                    1.0f,
                    memory_offset + 5*sizeof(glm::vec4),
                    sizeof(float)
                    );
        ...
        Engine::getRenderer()->GetUtility()->uploadFloat(
                    Engine::getRenderer()->ubo_spots,
                    0.35f,
                    memory_offset + 5*sizeof(glm::vec4)+4,
                    sizeof(float)
                    );
        ...
        Engine::getRenderer()->GetUtility()->uploadFloat(
                    Engine::getRenderer()->ubo_spots,
                    0.44f,
                    memory_offset + 5*sizeof(glm::vec4)+8,
                    sizeof(float)
                    );
        ...
        Engine::getRenderer()->GetUtility()->uploadFloat(
                    ...
                    memory_offset + 5*sizeof(glm::vec4)+12,
                    sizeof(float)
                    );
        ...
        Engine::getRenderer()->GetUtility()->uploadFloat(
                    ...
                    memory_offset + 6*sizeof(glm::vec4),
                    sizeof(float)
                    );
